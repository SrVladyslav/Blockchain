...
import "./../utils/npm/openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";

contract ImageCollectionOnChain is ERC721URIStorage {
    ...
    function safeMint(
        ...
        link = _link;
        string memory tokenURI = _getTokenURI(_imgURI, tokenCounter.current());
